...
$\hat{A}_ {11} ^ {L} = \hat{A}_ {11} + \frac{1}{2h}\Big( \frac{\partial{\lambda(\hat{q}_ {1} ^ {0} )}}{ \partial u }\cdot \hat{q}_ {1} ^ {0} - \frac{\partial{\lambda(\hat{q}_ {1} ^ {0} )}}{ \partial u }\cdot \hat{q}_ {2} ^ {0} \Big)$
